...
Počká sa určitý čas, ktorý je určený v poli zoznamVlakien v poslednom prvku v poli štruktúr CLIENT_INFO
...
URL_SLICED downloadInput()
{
  ...
  char *port_str[16];
  sprintf(port_str, "%d", urlSliced.port);
  printf("Port v downloadInput : %s\n", port_str);
